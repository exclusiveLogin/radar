...
/**
 * Generic-планировщик (ADR-003, Фаза G): `job_definitions` (что/по какому cron)
 * и `job_runs` (запуски с прогрессом). Паттерн `ingest_backfill_jobs`, обобщён.
 */
export class Jobs1748400000000 implements MigrationInterface {
  name = "Jobs1748400000000";

...
Быстрая фильтрация массива точек на read-side по типу события для классической тепловой карты. Аналитик в один клик видит географию очагов перехвата, взрывов или movement — без шума остальных типов.

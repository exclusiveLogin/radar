...
Один физический инцидент часто порождает несколько сообщений из разных Telegram-каналов с разницей в 1–5 минут: «Сызрань — ПВО» и «БПЛА над Монгорой». Без дедупликации Kalman получает кластер близких точек с разным timestamp → завышенная скорость и прогноз «в космос».
